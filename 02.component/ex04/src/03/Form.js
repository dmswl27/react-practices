...
export default function Form() {
    ...
    return (
        <form id="joinForm" name="joinForm" method="post" action="/do/not/post">
            ...
            <textarea id='selfDescription' name='selfDescription' value={ selfDescription } onChange={onChangeInputSelfDescription}/>

            <fieldset>
                <legend>약관동의</legend>
                <input id="agree-prov" type="checkbox" name="agreeProv" value= {agreeProv} checked={agreeProv === 'yes'} onChange={onChangeInputAgreeProv}/>
