...
ReactModal.setAppElement('body');     // modal 뒤에 클릭 할 수 없게 overlay한다.
    ...
    return (
        <Fragment>
            ...
            <Modal
                ...
                onRequestClose={ () => setModal02IsOpen(false) }    // 창 밖에 눌러서 꺼지는 효과 
            ...
            <Modal
                ...
                shouldCloseOnOverlayClick={ false }  // 위에 함수를 기본적으로 세팅하고 shouldCloseOnOverlayClick로 컨트롤하는것이 좋다.
            ...
            <Modal
                ...
                style={{
                    overlay: {
                        backgroundColor: 'rgba(0, 0, 0, 0.5)'   // rgba -> a는 투명하게 보여질 수 있도록 해줌
                    },
                    content: {
                        backgroundColor: '#ccc'
                    }
